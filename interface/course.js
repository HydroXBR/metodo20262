document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateCourseUI() {
        ...
        document.getElementById('courseType').textContent = curso.type === 'enem' ? 'ENEM/MACRO' : 'PSC/SIS';
    ...
    function renderSubjects() {
        ...
        currentState.materias.forEach(materia => {
            ...
            const expandBtn = subjectCard.querySelector('.expand-btn');
            expandBtn.addEventListener('click', function() {
                subjectCard.classList.toggle('expanded');
                
                if (subjectCard.classList.contains('expanded')) {
                    renderLessonsForSubject(subjectCard, materia);
                }
            });
